...
class AliyunOssAdapter extends AbstractAdapter
{
    ...
    public function __construct($prefix = '')
    {
        ...
        $this->accessKey = \config('filesystems.disks.aliyun-oss.key');
        $this->accessSecret = \config('filesystems.disks.aliyun-oss.secret');
        $this->bucketName = \config('filesystems.disks.aliyun-oss.bucket');
